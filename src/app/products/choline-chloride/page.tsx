        ...
        <div className="row" style={{maxWidth: '1200px', margin: '0 auto', padding: '0 40px'}}>
          ...
          <div style={{display: "flex", alignItems: "center", justifyContent: "center", gap: "0", marginBottom: "80px"}}>                      
            <div style={{display: "flex", justifyContent: "center", flex: 1, marginLeft: '320px'}}>
              <img src="/products/chlorine-chloride.png" alt="CHOLINE CHLORIDE fatty liver prevention egg production poultry supplement Kenya" style={{maxWidth: "420px", width: "100%", height: "450px"}} />
            </div>
          </div>
          ...
          <section style={{marginBottom: '50px'}}>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', marginTop: '20px'}}>
              <p style={{fontSize: '17px', lineHeight: '1.8', color: 'white'}}>
                Choline Chloride is essential for fat metabolism, liver function, and nerve transmission in animals. This vital nutrient prevents fatty liver disease and supports optimal growth and egg production. An indispensable component of modern poultry nutrition. Trusted by farmers across Kenya and East Africa for liver health and enhanced production performance.
              </p>
            </div>
          </section>          
          ...
          <section style={{marginBottom: '50px'}}>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', marginTop: '5px'}}>
              <div style={{fontSize: '17px', lineHeight: '1.8', color: 'white'}}>
                <p style={{marginBottom: '20px'}}><strong>For Layers:</strong></p>
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Mix 0.5-1kg per ton of feed</li>
                  <li>Use continuously throughout production</li>
                </ul>
                
                <p style={{marginBottom: '20px'}}><strong>For Broilers:</strong></p>
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Mix 0.75-1.5kg per ton of feed</li>
                  <li>Higher rates for rapid growth phase</li>
                </ul>
                <p style={{fontStyle: 'italic', color: '#666', marginTop: '20px'}}>
                  Note: Adjust based on other choline sources in diet. Store in a dry place.
                </p>
              </div>
            </div>
          </section>
