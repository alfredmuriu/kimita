        ...
        <div className="row" style={{maxWidth: '1200px', margin: '0 auto', padding: '0 40px'}}>
          ...
          <div style={{display: "flex", alignItems: "center", justifyContent: "center", gap: "0", marginBottom: "80px"}}>                      
            <div style={{display: "flex", justifyContent: "center", flex: 1, marginLeft: '320px'}}>
              <img src="/products/therionine.png" alt="THREONINE amino acid poultry gut health immune function supplement Kenya" style={{maxWidth: "420px", width: "100%", height: "450px"}} />
            </div>
          </div>
          ...
          <section style={{marginBottom: '50px'}}>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', marginTop: '20px'}}>
              <p style={{fontSize: '17px', lineHeight: '1.8', color: 'white'}}>
                Threonine is an essential amino acid that supports immune function, intestinal health, and protein balance in livestock. This vital nutrient enhances nutrient absorption, promotes gut integrity, and contributes to overall animal welfare. Essential for optimal growth and production. Trusted by farmers across Kenya and East Africa for amino acid supplementation.
              </p>
            </div>
          </section>
          ...
          <section style={{marginBottom: '50px'}}>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', borderRadius: '8px', marginTop: '20px'}}>
              <ul style={{fontSize: '17px', lineHeight: '2', color: 'white', paddingLeft: '20px'}}>
                <li>L-Threonine (98.5% min)</li>
                <li>Feed Grade Quality</li>
                <li>High Purity Crystalline Powder</li>
              </ul>
            </div>
          </section>
          ...
          <section style={{marginBottom: '50px'}}>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', marginTop: '5px'}}>
              <div style={{fontSize: '17px', lineHeight: '1.8', color: 'white'}}>
                ...
                <p style={{marginBottom: '20px'}}><strong>For Swine:</strong></p>
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Mix 1-2kg per ton of feed</li>
                  <li>Based on growth stage requirements</li>
                </ul>
                <p style={{fontStyle: 'italic', color: '#666', marginTop: '20px'}}>
                  Note: Consult nutritionist for precise inclusion rates. Store in a dry place.
                </p>
              </div>
            </div>
          </section>
