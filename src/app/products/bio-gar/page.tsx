        ...
        <div className="row" style={{maxWidth: '1200px', margin: '0 auto', padding: '0 40px'}}>
          ...
          <section style={{marginBottom: '50px'}}>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', borderRadius: '8px', marginTop: '20px'}}>
              <ul style={{fontSize: '17px', lineHeight: '2', color: 'white', paddingLeft: '20px'}}>
                <li>Beneficial Probiotics</li>
                <li>Prebiotics (FOS, MOS)</li>
          ...
          <section style={{marginBottom: '50px'}}>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', borderRadius: '8px', marginTop: '5px'}}>
              <ul style={{fontSize: '17px', lineHeight: '2', color: 'white', paddingLeft: '20px'}}>
                <li>Enhances gut health and microbiome balance</li>
                <li>Natural prevention of coccidiosis</li>
                <li>Improves nutrient absorption and feed efficiency</li>
                <li>Supports natural immunity in poultry</li>
                <li>Reduces diarrhea and digestive disturbances</li>
                <li>Promotes healthy weight gain in broilers</li>
                <li>Safe alternative to antibiotic growth promoters</li>
          ...
          <section style={{marginBottom: '50px'}}>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', marginTop: '5px'}}>
              <div style={{fontSize: '17px', lineHeight: '1.8', color: 'white'}}>
                <p style={{marginBottom: '20px'}}><strong>For Feed Mixing:</strong></p>
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Mix 1kg per ton of feed</li>
                  <li>Use continuously for best results</li>
                </ul>
                
                <p style={{marginBottom: '20px'}}><strong>For Treatment:</strong></p>
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Increase to 2kg per ton of feed</li>
                  <li>Administer for 7-14 days</li>
                </ul>
