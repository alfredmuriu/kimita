  ...
  return (
    <Layout>
      ...
      <style dangerouslySetInnerHTML={{
        ...
        .s-folio, .target-section, .bricks-wrapper, .row, .brick, .entry, .masonry {
        ...
        .entry__title, .entry:hover .entry__title, .entry__info .entry__title {
            color: #000000 !important;
        }
        .entry__cat, .entry:hover .entry__cat, .entry__info .entry__cat {
            color: #000000 !important;
        }
        .entry__page-link::before, .entry__link::before {
            background: rgba(255, 255, 255, 0.85) !important;
        }
        .entry__page-link::after, .entry__link::after {
            color: #000000 !important;
        }
        .s-folio.target-section {
            background-color: #f6f6f6 !important;
      ...
      <main>
        <section id="folio" className="s-folio target-section">
          ...
          <h3 id="supplements" className="column lg-12 section-header__pretitle pretitle text-pretitle products-category-title">SUPPLEMENTS</h3>
          ...
          <h3 id="feed-additives" className="column lg-12 section-header__pretitle pretitle text-pretitle products-category-title">FEED ADDITIVES</h3>
          <div id="bricks" className="row bricks">
            <div className="column lg-12 masonry">
              <div className="bricks-wrapper">
                <div className="grid-sizer"></div>
