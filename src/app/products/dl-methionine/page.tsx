        ...
        <div className="row" style={{maxWidth: '1200px', margin: '0 auto', padding: '0 40px'}}>
          ...
          <div style={{display: "flex", alignItems: "center", justifyContent: "center", gap: "0", marginBottom: "80px"}}>                      
            <div style={{display: "flex", justifyContent: "center", flex: 1, marginLeft: '320px'}}>
              <img src="/products/Dl-Methionine.png" alt="DL-METHIONINE amino acid feather development poultry growth supplement Kenya" style={{maxWidth: "420px", width: "100%", height: "450px"}} />
            </div>
          </div>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', marginTop: '5px'}}>
              <div style={{fontSize: '17px', lineHeight: '1.8', color: 'white'}}>
                ...
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Mix 1-2.5kg per ton of feed</li>
                  <li>Higher rates for starter diets</li>
                </ul>
                
                <p style={{marginBottom: '20px'}}><strong>For Layers:</strong></p>
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Mix 1-1.5kg per ton of feed</li>
                  <li>Adjust based on production stage</li>
                </ul>
                <p style={{fontStyle: 'italic', color: '#666', marginTop: '20px'}}>
                  Note: Consult nutritionist for precise formulation. Store in a dry, cool place.
                </p>
              </div>
            </div>
          </section>
