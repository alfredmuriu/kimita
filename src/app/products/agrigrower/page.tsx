        ...
        <div className="row" style={{maxWidth: '1200px', margin: '0 auto', padding: '0 40px'}}>
          ...
          <div style={{display: "flex", alignItems: "center", justifyContent: "center", gap: "0", marginBottom: "80px"}}>                      
            <div style={{display: "flex", justifyContent: "center", flex: 1, marginLeft: '320px'}}>
              <img src="/products/agrigrower.png" alt="AGRIGROWER poultry grower feed additive optimal growth development Kenya" style={{maxWidth: "420px", width: "100%", height: "450px"}} />
            </div>
          </div>
          ...
          <section style={{marginBottom: '50px'}}>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', marginTop: '5px'}}>
              <div style={{fontSize: '17px', lineHeight: '1.8', color: 'white'}}>
                <p style={{marginBottom: '20px'}}><strong>For Broiler Growers (14-28 days):</strong></p>
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Mix 2.5-5kg per ton of feed</li>
                  <li>Use continuously through grower phase</li>
                </ul>
                
                <p style={{marginBottom: '20px'}}><strong>For Layer Pullets:</strong></p>
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Mix 2-4kg per ton of feed</li>
                  <li>Continue until point of lay</li>
                </ul>
                <p style={{fontStyle: 'italic', color: '#666', marginTop: '20px'}}>
                  Note: Transition gradually from starter feed. Store in a cool, dry place.
                </p>
              </div>
            </div>
          </section>
