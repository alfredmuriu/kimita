        ...
        <div className="row" style={{maxWidth: '1200px', margin: '0 auto', padding: '0 40px'}}>
          ...
          <div style={{display: "flex", alignItems: "center", justifyContent: "center", gap: "0", marginBottom: "80px"}}>                      
            <div style={{display: "flex", justifyContent: "center", flex: 1, marginLeft: '320px'}}>
              <img src="/products/antistrs-300.png" alt="ANTISTRS-300 anti-stress formula poultry heat stress vaccination recovery Kenya" style={{maxWidth: "420px", width: "100%", height: "450px"}} />
            </div>
          </div>
          ...
          <section style={{marginBottom: '50px'}}>
            ...
            <div style={{backgroundColor: 'transparent', padding: '30px', marginTop: '5px'}}>
              <div style={{fontSize: '17px', lineHeight: '1.8', color: 'white'}}>
                <p style={{marginBottom: '20px'}}><strong>During Heat Stress:</strong></p>
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Mix 1ml per 1 liter of drinking water</li>
                  <li>Administer during hot hours of the day</li>
                </ul>
                
                <p style={{marginBottom: '20px'}}><strong>Post-Vaccination/Transportation:</strong></p>
                <ul style={{paddingLeft: '20px', marginBottom: '20px'}}>
                  <li>Mix 1ml per 1 liter of drinking water</li>
                  <li>Administer for 2-3 days before and after event</li>
                </ul>
                <p style={{fontStyle: 'italic', color: '#666', marginTop: '20px'}}>
                  Note: Increase water availability during stress periods. Store in a cool place.
                </p>
              </div>
            </div>
          </section>
