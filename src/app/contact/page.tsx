                ...
                <form className="tw-form">
                    ...
                    <div className="tw-row">
                        <div className="tw-input-wrapper">
                            ...
                            <input className="tw-input" id="name" type="text" required />
                        </div>
                        <div className="tw-input-wrapper">
                            <label className="tw-label" htmlFor="email">Your Email</label>
                            <input className="tw-input" id="email" type="email" required />
                        </div>
                    </div>

                    <div className="tw-message-row">
                        <label className="tw-label" htmlFor="message">Message</label>
                        <textarea className="tw-textarea" id="message" required></textarea>
                    </div>

                    <button type="submit" className="btn btn--primary cta-btn" style={{ backgroundColor: '#026c6a', color: '#ffffff', border: 'none', marginTop: '40px', cursor: 'pointer', fontFamily: 'Inter, sans-serif' }}>
                        SEND MESSAGE
                    </button>
                </form>
            </div>
