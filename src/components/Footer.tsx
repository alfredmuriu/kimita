    ...
    <footer id="footer" className="s-footer target-section">
      ...
      <div className="row footer-content">
        ...
        <div className="footer-links">
          ...
          <ul className="contact-list" style={{listStyle: 'none', margin: 0, padding: 0, fontSize: '15px'}}>
            ...
            <li style={{marginBottom: '0.5px'}}><a href="/articles" style={{color: 'rgba(0, 0, 0, 0.6)'}}>What's New</a></li>
            <li style={{marginBottom: '0.5px'}}><a href="/education" style={{color: 'rgba(0, 0, 0, 0.6)'}}>Academy</a></li>
            <li style={{marginBottom: '0.5px'}}><a href="/downloads" style={{color: 'rgba(0, 0, 0, 0.6)'}}>Downloads</a></li>
            <li style={{marginBottom: '0.5px'}}><a href="/contact" style={{color: 'rgba(0, 0, 0, 0.6)'}}>Contact Us</a></li>
          </ul>
        </div>
        ...
        <div className="footer-contact">
          ...
          <ul className="contact-list" style={{listStyle: 'none', margin: 0, padding: 0, fontSize: '15px'}}>
            ...
            <li style={{marginBottom: '8px'}}><a href="https://wa.me/254111410639" style={{color: 'rgba(0, 0, 0, 0.6)'}}>WhatsApp: +254 111 410 639</a></li>
      ...
      <div className="row s-footer__bottom footer-bottom">
        ...
        <ul className="s-footer__social footer-social">
          ...
          <li>
            <a href="https://www.facebook.com/AgriKimaSdnBhd/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill: 'rgba(255, 255, 255, 0.6)'}}>
          ...
          <li>
            <a href="https://x.com/AgrikimaB" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill: 'rgba(255, 255, 255, 0.6)'}}>
