...
(function(html) {
    ...
    * ------------------------------------------------------ */
     const ssMasonry = function() {
        ...
        const containerBricksList = document.querySelectorAll('.bricks-wrapper');
        if (!containerBricksList.length) return;

        containerBricksList.forEach(function(containerBricks) {
    ...
    * ------------------------------------------------------ */
    const ssLightbox = function() {
        ...
        const videoLightbox = function() {
            ...
            // Removed video lightbox for intro video button. Now opens in new tab.
        };
